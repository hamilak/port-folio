    ...
    return (
        <div className='leading-8'>
            <div className='w-full lg:w-1/2 float-left'>
                <div className='mb-4'>
                    <div>
                        <h5 className='text-4xl mb-2'>My name is <span className='uppercase underline'>Kalimah Arigbabu</span>, I’m a full-stack developer working and living in Nigeria.</h5>
                        <p className='font-medium text-xl leading-8'>I started coding because I genuinely love solving problems, and over time, I’ve picked up a well-rounded set of skills, from building solid backends to creating smooth, responsive frontends. I’m always open to feedback, continuously refining my skills to deliver the best possible outcomes.</p>
                        <p className='font-medium text-xl leading-8'>Every day is an opportunity to learn something new in the world of tech, and that’s what keeps me motivated.</p>
                    </div>
                </div>
                <div className=''>
                    <div>
                        ...
                        <div className=''>
                            {services.map((item) => (
                                <div key={item.name} className="rounded-md flex flex-col justify-between min-h-32 py-4">
                                    <div>
